...
const fallbackSuppliers: SupplierSearchResult[] = [
  ...
  {
    id: "4",
    slug: "ecobuild-materials",
    tradingName: "EcoBuild Materials",
    shortDescription:
      "Manufacturer of eco-friendly building materials including recycled concrete, bamboo panels, and green insulation.",
    city: "Pretoria",
    countryCode: "ZA",
    ...
    esgScore: 42,
    logoUrl: null,
    industries: ["Green Construction", "Manufacturing"],
    isVerified: false,
  },
  {
    id: "5",
    slug: "clean-harvest-farms",
    tradingName: "Clean Harvest Farms",
    shortDescription:
      "Organic farming cooperative supplying sustainably grown produce to major South African retailers.",
    city: "Stellenbosch",
    countryCode: "ZA",
    verificationStatus: "Verified",
    esgLevel: "gold",
    esgScore: 75,
    logoUrl: null,
    industries: ["Sustainable Agriculture"],
    isVerified: true,
  },
  {
    id: "6",
    slug: "carbon-zero-sa",
    tradingName: "CarbonZero SA",
    shortDescription:
      "Carbon offset and emissions management consultancy helping enterprises achieve net-zero targets.",
    city: "Sandton",
    countryCode: "ZA",
    verificationStatus: "Verified",
    esgLevel: "platinum",
